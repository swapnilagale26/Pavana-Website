...
<html lang="zxx">
<head>
<title>Pavana Lake Camping</title>
<meta charset="UTF-8">
...
<header id="nav-transparent">
  <nav id="navigation4" class="container-fluid navigation">
    <div class="nav-header"><a class="nav-brand" href="index.php"><img src="img/camp.png" class="main-logo" alt="logo" id="main_logo" style="display: none;margin:8px;height: 70px;
    width: 70px;"></a>
